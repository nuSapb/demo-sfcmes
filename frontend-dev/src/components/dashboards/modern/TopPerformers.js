...
const TopPerformers = memo(({ onProjectSelect, userRole, refreshTrigger, onTabChange, userId }) => {
  ...
  return (
    <Box sx={{ backgroundColor: 'transparent' }}>
        ...
        >
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 500 }}>
              สถานะผู้ใช้: <strong>{userRole}</strong>
            </Typography>
          </Box>
      ...
      {/* Projects Grid - World-Class Design */}
      {state.tabValue === '1' && (
        <ProjectsList
      ...
      {/* Old Table Container - To be removed */}
      {false && (
        <TableContainer
          sx={{
            maxHeight: '60vh',
        ...
        >
          <Table sticky stickyHeader size={isSmallScreen ? 'small' : 'medium'}>
            <TableHead>
              <TableRow
                sx={{
                  backgroundColor: theme.palette.primary.main,
              ...
              >
                ...
                {!isSmallScreen && <TableCell>ชื่อโครงการ</TableCell>}
                {!isSmallScreen && <TableCell align="right">จำนวนชั้น</TableCell>}
                <TableCell align="right">จำนวนชิ้นงาน</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {filteredProjects.length > 0 ? (
                filteredProjects.map((project, index) => (
                  ...
                  >
                    ...
                    <TableCell sx={{ fontWeight: 600 }}>{project.project_code}</TableCell>
                    {!isSmallScreen && <TableCell>{project.name}</TableCell>}
                    {!isSmallScreen && (
