...
import { STATUS_COLORS, CARD, FONT_SIZE } from './designTokens';
            ...
            <Grid item xs={2.4} sm={2.4} md={2.4} lg={2.4} xl={2.4} key={i}>
              <Box
                sx={{
                  ...
                  height: '100%',
                  minHeight: isXsScreen ? 60 : CARD.minHeight,
                  display: 'flex',
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    lineHeight: 1.2,
                    fontSize: isXsScreen ? FONT_SIZE.xs : (isSmScreen ? FONT_SIZE.sm : FONT_SIZE.md),
                ...
                <Typography
                  ...
                  align="center"
                  sx={{
                    fontSize: isXsScreen ? FONT_SIZE.sm : (isSmScreen ? FONT_SIZE.md : FONT_SIZE.lg),
                ...
                <Typography
                  ...
                  align="center"
                  sx={{
                    fontSize: isXsScreen ? FONT_SIZE.xs : (isSmScreen ? FONT_SIZE.xs : FONT_SIZE.sm),
