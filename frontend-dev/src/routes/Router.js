...
const AiAssistant = Loadable(lazy(() => import('../views/ai-assistant/AiAssistant')));
...
// analytics
const ProjectCostDashboard = Loadable(lazy(() => import('../views/analytics/projects/ProjectCostDashboard')));
const ProjectHealthOverview = Loadable(lazy(() => import('../views/analytics/projects/ProjectHealthOverview')));
const ProductionEfficiencyDashboard = Loadable(lazy(() => import('../views/analytics/production/ProductionEfficiencyDashboard')));

// materials
const MaterialCalculator = Loadable(lazy(() => import('../views/materials/MaterialCalculator')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/ai-assistant', exact: true, element: <AiAssistant /> },
      ...
      { path: '/analytics/projects', element: <ProjectHealthOverview /> },
      { path: '/analytics/projects/:id/cost', element: <ProjectCostDashboard /> },
      { path: '/analytics/production', element: <ProductionEfficiencyDashboard /> },
      { path: '/materials/calculator', element: <MaterialCalculator /> },
