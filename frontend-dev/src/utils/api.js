...
export const updateComponentWithFile = async (componentId, formData) => {
  try {
    const response = await api.put(`/components/${componentId}/updateWithFile`, formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    });
    return response.data;
  } catch (error) {
...
const fetchProjectCostAnalytics = async (projectId) => {
  try {
    const response = await api.get(`/analytics/projects/${projectId}/cost`);
    return response.data;
  } catch (error) {
    console.error('Error fetching project cost analytics:', error);
    throw error;
  }
};
...
const fetchProductionSummary = async () => {
  try {
    const response = await api.get('/analytics/production/summary');
    return response.data;
  } catch (error) {
...
const fetchProjectsHealth = async () => {
  try {
    const response = await api.get('/analytics/projects/health');
    return response.data;
  } catch (error) {
...
// Material calculation APIs
const fetchMaterialUnitPrices = async () => {
  try {
    const response = await api.get('/materials/unit-prices');
    return response.data;
  } catch (error) {
    console.error('Error fetching material unit prices:', error);
    throw error;
  }
};

const updateMaterialUnitPrices = async (prices) => {
  try {
    const response = await api.put('/materials/unit-prices', prices);
    return response.data;
  } catch (error) {
    console.error('Error updating material unit prices:', error);
    throw error;
  }
};
...
export {
  ...
  fetchProjectCostAnalytics,
  fetchProductionSummary,
  fetchProjectsHealth,
  fetchMaterialUnitPrices,
  updateMaterialUnitPrices,
};
